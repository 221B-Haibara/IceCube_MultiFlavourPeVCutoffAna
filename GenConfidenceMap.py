...
if __name__ == "__main__":
    ...
    for iParam, iData in theReader.items(): #will run over 20 energy bins
        ...
        #print logLDistributions[iParam][count]
        ...
        outputshelve = shelve.open(myConfig.outputshelve)
        outputshelve.clear()
        ...
        fig.savefig(os.path.join(myConfig.plotDirectory,"CL_LLHR_" + str(iParam) +"_"+ str(count) + ".png"))
