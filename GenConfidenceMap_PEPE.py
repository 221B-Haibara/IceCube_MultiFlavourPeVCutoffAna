...
if __name__ == "__main__":
    theReader = reader.input_PEPE_shelve
    ...
    for iParam, iData in theReader.items(): #will run over 20 energy bins
        ...
        outputshelve = shelve.open(myConfig.output_PEPE_shelve)
        outputshelve.clear()
        ...
        fig.savefig(os.path.join(myConfig.plotDirectory,"CL_LLHR_PEPE_" + str(iParam) +"_"+ str(count) + ".png"))
