#this program calculates the -2llr distribeution when set Ecut at the sliding energy
...
if __name__ == "__main__":
    theReader = reader.input_EHE_shelve
    ...
    for iParam, iData in theReader.items(): #will run over 20 energy bins
        ...
        outputshelve = shelve.open(myConfig.output_EHE_shelve)
        outputshelve.clear()
        ...
        fig.savefig(os.path.join(myConfig.plotDirectory,"CL_LLHR_EHE_" + str(iParam) +"_"+ str(count) + ".png"))
